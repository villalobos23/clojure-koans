...
(meditations
  ...
  "But strings and characters are not the same" ;https://stackoverflow.com/questions/3970830/which-is-the-most-clojuresque-way-to-compare-characters-and-string-single-char
  (= false (= \c "c"))
  ...
  (= "123" (string/join '(1 2 3))) ;https://clojuredocs.org/clojure.core/quote https://8thlight.com/blog/colin-jones/2012/05/22/quoting-without-confusion.html
